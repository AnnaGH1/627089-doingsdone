            ...
            <main class="content__main">
                ...
                <table class="tasks">
                    <?php foreach ($tasks as $key => $item): ?>
                        <?php if(($item['done'] === true && $show_complete_tasks === 1) || $item['done'] === false): ?>
                            <tr class="tasks__item task<?php if($item['done'] === true): ?> task--completed<?php endif; ?>">
                                <td class="task__select">
                                    <label class="checkbox task__checkbox">
                                        <input class="checkbox__input visually-hidden task__checkbox" type="checkbox" value="1" <?php if($item['done'] === true): ?>checked<?php endif; ?>>
